...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 12 2021 г., 11:14
...
(4, 10, 'adsdsadsasdfsjdf123asdtyvkgubhlaidkfjrgodjgksdjlgdlnfvndzkjnlmkdoeifklm,efalkzjddfbjkfnjSzkdnkvfkzdnkvfpnlzdjnfpzdjxnfmvpozfdlgkmoglmkpdgblzmkdpofmgblmkzpdpmklfxgbmkpbzmkgmlkpgpmzlbdggmbkgzmkdlgm fgbbzdg/lfmlb,zdml'),
(5, 12, '1234567890-dfh');
...
CREATE TABLE `vacancy` (
  ...
  `zp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `otklik`
  ADD CONSTRAINT `otklik_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `otklik_ibfk_2` FOREIGN KEY (`id_vacancy`) REFERENCES `vacancy` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;
